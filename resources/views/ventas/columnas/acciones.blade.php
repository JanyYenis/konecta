...
<div class="card-toolbar">
    <div class="dropdown dropdown-inline">
        ...
        <div class="dropdown-menu dropdown-menu-md dropdown-menu-right btnAccionesVentas" x-placement="top-end" style="position: absolute; transform: translate3d(-200px, -350px, 0px); top: 0px; left: 0px; will-change: transform;">
            <ul class="navi navi-hover">
                ...
                <li class="navi-item">
                    <a class="navi-link btnEditarVenta" title="Editar Venta." data-modificar="{{$id}}">
                ...
                @if ($estado)
                    <li class="navi-item">
                        <a class="navi-link btnEliminarVenta" title="Eliminar Venta." data-eliminar="{{$id}}">
