...
<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
    ...
    <div class="brand flex-column-auto" id="kt_brand" kt-hidden-height="65" style="">
        ...
        <a href="{{url('/')}}" class="brand-logo">
            <img alt="Logo" src="{{ asset('img/logo.png') }}" width="100" height="100">
        </a>
        <!--end::Logo-->
        <!--begin::Toggle-->
    ...
    <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
        ...
        <div id="kt_aside_menu" class="aside-menu my-4 scroll ps ps--active-y" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500" style="height: 566px; overflow: hidden;">
            ...
            <ul class="menu-nav">
                ...
                {{-- Productos --}}
                @component('layouts.asides.productos')
                @endcomponent
                
                {{-- Ventas --}}
                @component('layouts.asides.ventas')
                @endcomponent

            </ul>
            <!--end::Menu Nav-->
        <div class="ps__rail-x" style="left: 0px; bottom: 0px;"><div class="ps__thumb-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps__rail-y" style="top: 0px; height: 566px; right: 4px;"><div class="ps__thumb-y" tabindex="0" style="top: 0px; height: 278px;"></div></div></div>
        <!--end::Menu Container-->
    </div>
    <!--end::Aside Menu-->
</div>
